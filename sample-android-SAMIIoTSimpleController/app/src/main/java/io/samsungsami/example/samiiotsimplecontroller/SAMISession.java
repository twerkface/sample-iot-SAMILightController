...
public class SAMISession {
    ...
    public final static String WEBSOCKET_WS_ONOPEN =
            "io.samsungsami.example.iot.WEBSOCKET_WS_ONOPEN";
    public final static String WEBSOCKET_WS_ONREG =
            "io.samsungsami.example.iot.WEBSOCKET_WS_ONREG";
    public final static String WEBSOCKET_WS_ONMSG =
            "io.samsungsami.example.iot.WEBSOCKET_WS_ONMSG";
    public final static String WEBSOCKET_WS_ONACK =
            "io.samsungsami.example.iot.WEBSOCKET_WS_ONACK";
    public final static String WEBSOCKET_WS_ONCLOSE =
            "io.samsungsami.example.iot.WEBSOCKET_WS_ONCLOSE";
    public final static String WEBSOCKET_WS_ONERROR =
            "io.samsungsami.example.iot.WEBSOCKET_WS_ONERROR";
